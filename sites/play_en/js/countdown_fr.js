...
CountdownTimer.prototype={
  initialize:function(elm,tl,mes) {
    ...
    if( ( this.tl - today ) > 0 ){
      timer += '<span class="number-wrapper"><div class="caption day">JOURS</div><span class="number day">'+this.addZero(day)+'</span></span>';
      timer += '<span class="number-wrapper"><div class="caption hour">HEURES</div><span class="number hour">'+this.addZero(hour)+'</span></span>';
...
function CDT(){
  // Set countdown limit
  var tl = new Date('2016/03/18 18:00:00');
